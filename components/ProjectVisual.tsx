...
export function ProjectVisual({
  ...
  return (
    <div
      className={`project-visual visual-${project.visual} ${compact ? 'visual-compact' : ''}`}
      style={common}
      aria-hidden="true"
    >
      ...
      {project.visual === 'cad' && (
        <svg viewBox="0 0 1200 720" role="img">
          ...
          <text x="102" y="370" fill="currentColor" fontSize="22" transform="rotate(-90 102 370)">
            STRUCTURAL SECTION
          </text>
        </svg>
      )}
      {project.visual === 'building' && (
        <svg viewBox="0 0 1200 720" role="img">
          ...
          />
          <path
            d="M520 380V518M520 518L462 558M520 518L582 558"
            stroke="currentColor"
            strokeWidth="3"
      ...
      {project.visual === 'mobile' && (
        <svg viewBox="0 0 1200 720" role="img">
          ...
          <path
            d="M160 190H350M160 238H310M850 444H1040M890 492H1040"
            stroke="currentColor"
            strokeWidth="12"
          />
        </svg>
      ...
      {project.visual === 'agent' && (
        <svg viewBox="0 0 1200 720" role="img">
          ...
          {[
            ...
            <g key={i}>
              <circle cx={x} cy={y} r="56" fill="none" stroke="currentColor" strokeWidth="3" />
              <line
                x1="600"
                y1="360"
                x2={x}
          ...
          <path
            d="M232 180H288M910 182H966M220 548H276M922 544H978"
            stroke="currentColor"
            strokeWidth="8"
          />
        </svg>
      ...
      <span className="visual-label mono">
        {project.index} / {project.shortTitle}
      </span>
    </div>
  );
}
