...
export default function HomePage() {
  return (
    <>
      ...
      <section id="expertise" className="capabilities section-shell" aria-labelledby="capabilities-title">
        <div className="section-intro sticky-intro">
          ...
          <p className="section-lead">The portfolio is intentionally broader than a framework list: each area describes the layer of a product I can own.</p>
        </div>
      ...
      <section className="ai-band section-shell" aria-labelledby="ai-title">
        ...
        <h2 id="ai-title">Models are most useful when they can act inside a well-designed software system.</h2>
        <div className="ai-copy-grid">
          <p>I use language models across research, architecture, implementation, testing and automation — and integrate them as product capabilities when a workflow benefits from it.</p>
          <p className="mono">LLM INTEGRATION / TOOL CALLING / STRUCTURED OUTPUTS / AGENTIC WORKFLOWS / CONTEXT ENGINEERING</p>
        </div>
      </section>
      ...
      <section className="about-strip section-shell">
        ...
        <Link href="/about" className="text-link">About & working approach ↗</Link>
      </section>
    </>
  );
}
